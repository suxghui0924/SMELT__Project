...
public class ChangeTip : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            textmesh.text = "TIP - 박성희 화이팅!";
        }
        else if (chooseTip == 6)
        {
            textmesh.text = "TIP - 손님들의 요구를 늦게 들어주면 받는돈이 줄어듭니다.";
        }
        else if (chooseTip == 7)
        {
            textmesh.text = "TIP - 경기게임마이스터고등학교를 아시나요? 진.짜.재.밌.습.니.다";
        }
        else if (chooseTip == 8)
        {
            textmesh.text = "TIP - 프로그래밍 기능사 원트에 따게 해주세요.";
        }
    }
}
